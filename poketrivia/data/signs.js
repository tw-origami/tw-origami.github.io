...
window.SIGN_FACTS = [
  ...
  { id: 'f-sci-1', zone: 'science', subject: 'science', band: 'A', diff: 'easy',
    fact: 'VOLCANO SIGN: Most of the world\'s volcanoes sit in a giant horseshoe around the Pacific Ocean called the Ring of Fire.',
    q: 'What is the Ring of Fire?',
    choices: [{ html: 'A ring of volcanoes around the Pacific Ocean', ok: true },
      { html: 'A circle of lava inside every volcano' },
      { html: 'A famous wildfire' }, { html: 'The Sun\'s outer layer' }],
    reveal: 'About three-quarters of Earth\'s volcanoes sit on the Ring of Fire, where the Pacific plate grinds against its neighbours. Most big earthquakes happen there too.' },
  ...
  { id: 'f-hist-1', zone: 'history', subject: 'history', band: 'A', diff: 'easy',
    fact: 'CARVED STONE: The Great Wall of China is more than 13,000 miles long — built over many centuries to guard the empire\'s northern edge.',
    q: 'Which country built the Great Wall?',
    choices: [{ html: 'China', ok: true }, { html: 'Egypt' },
      { html: 'Italy' }, { html: 'India' }],
    reveal: 'Chinese dynasties built and rebuilt the wall for around 2,000 years. Counting every branch, it runs over 13,000 miles — more than halfway around the Earth.' },
  ...
  { id: 'f-hist-4', zone: 'history', subject: 'history', band: 'A', diff: 'easy',
    fact: 'CARVED STONE: The ancient Romans built roads so straight and strong that some are still used two thousand years later.',
    q: 'Some roads built two thousand years ago are still used today. Who built them?',
    choices: [{ html: 'The Romans', ok: true }, { html: 'The Vikings' },
      { html: 'The pharaohs' }, { html: 'Medieval knights' }],
    reveal: 'Roman roads were layered stone with drainage, built for marching armies. "All roads lead to Rome" was nearly literal — over 50,000 miles of them fanned out from the city.' },
