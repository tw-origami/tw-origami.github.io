...
window.BIZ = {
  ...
  TERMS: [
    { term:'Revenue', def:'All the money a business takes IN from selling things — before any costs are subtracted.', ex:'Sell 50 smoothies at $5 each → $250 revenue.' },
    { term:'Cost (Expense)', def:'Money a business spends to operate — supplies, rent, ads, wages.', ex:'Fruit, cups, and cart rent are all costs.' },
    { term:'Profit', def:'What’s left after you subtract costs from revenue. Profit = Revenue − Costs.', ex:'$250 revenue − $110 costs = $140 profit.' },
    { term:'Loss', def:'When costs are bigger than revenue — the business lost money that day.', ex:'$80 revenue − $120 costs = −$40 (a loss).' },
    { term:'Fixed Cost', def:'A cost that stays the same no matter how much you sell.', ex:'Rent is $20 a day whether you sell 1 smoothie or 100.' },
    { term:'Variable Cost', def:'A cost that changes with how much you make or sell.', ex:'Each extra smoothie needs more fruit — a variable cost.' },
    { term:'Markup', def:'How much you add on top of what an item cost you, to make a profit.', ex:'A shirt costs you $8; you sell it for $20 — a $12 markup.' },
    { term:'Profit Margin', def:'The share of the price that is profit, shown as a percent.', ex:'$5 smoothie with $2 cost → $3 profit = 60% margin.' },
    { term:'Supply & Demand', def:'Demand = how much people want it. Supply = how much is available. Together they push prices up or down.', ex:'Heat wave = high demand for cold smoothies → you can charge more.' },
    { term:'Inventory (Stock)', def:'The products or supplies a business has on hand to sell.', ex:'Buying 40 smoothies’ worth of fruit is your inventory.' },
    { term:'Cash Flow', def:'The money moving in and out of a business. Run out of cash and you’re stuck — even if you’re profitable on paper.', ex:'Spend all your cash on stock and you can’t pay rent.' },
    { term:'Break-even', def:'The point where revenue exactly equals costs — no profit, no loss.', ex:'You break even the moment sales cover all your costs.' },
    { term:'Marketing', def:'Everything you do to get people to notice and want your product.', ex:'Posting on social media or handing out flyers.' },
    { term:'Brand', def:'The personality, name and look people recognize and trust.', ex:'The logo, colors and vibe that make your shop feel like YOU.' },
    { term:'Target Market', def:'The specific group of people most likely to buy from you.', ex:'Thirsty park-goers on a hot day are a smoothie cart’s target market.' },
    { term:'Competitor', def:'Another business trying to win the same customers as you.', ex:'The other smoothie stand across the park.' },
    { term:'Investor', def:'Someone who gives a business money now, hoping to earn more back later — often for part-ownership.', ex:'An investor gives $500 for 20% of your company.' },
    { term:'ROI (Return on Investment)', def:'How much you get back compared to what you spent. Higher is better.', ex:'Spend $10 on ads, earn $40 extra → a great ROI.' },
    { term:'Wholesale vs Retail', def:'Wholesale = buying in bulk cheaply; retail = selling one-at-a-time to shoppers for more.', ex:'Buy shirts wholesale at $8, sell retail at $20.' },
    { term:'Customer', def:'The person who buys your product. Keeping them happy = repeat business.', ex:'A happy customer tells friends and comes back.' }
  ],
