...
window.STUDENTS = [
  ...
  },
  {
    ...
    subjects: [
      ...
      { subject: "Spelling", book: "Spectrum Spelling 4", pace: "1–2 pages", goal: 3, workbook: true, page: 6, last: 144,
        goalText: "3 book + 3 Spell It", altLabel: "— plus —",
        alt: [{ label: "Learn Zone → Spell It", boxes: 3 }],
        queue: [
          "Lesson 1: Words with the Short a and Short e Sounds — pp.6–9",
          "Lesson 2: Words with the Short i, o, and u Sounds — pp.10–13",
          "Lesson 3: Words with scr, squ, str, and thr — pp.14–17",
          "Lesson 4: Words with ch and sh — pp.18–21",
          "Lesson 5: Silent Letters: Words with gn, mb, tch, and wr — pp.22–25" ] },
