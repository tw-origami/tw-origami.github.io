...
window.LIT = {
  ...
  THEME: [
    { title:'The Race',
      ...
      options:['Steady effort beats overconfidence','Resting whenever you feel tired is the smartest race plan','The naturally faster runner is bound to win every time','Entering a race you might lose just isn’t worth it'],
    ...
    { title:'The Locket',
      ...
      options:['Kindness matters more than money','Gold jewelry sells for a lot','Tracking down a stranger wastes a whole afternoon','Elderly people tend to misplace their belongings'],
    ...
    { title:'The New Kid',
      ...
      options:['Don’t judge people by appearances','Science fair projects are graded very harshly','Quiet students rarely have any useful skills','Wearing neat clothes earns people’s respect'],
    ...
    { title:'The Wall',
      ...
      options:['Cooperation is stronger than conflict','Tall fences make for good boundaries','A wildfire will always destroy a farm completely','Neighbors who argue can never truly be trusted'],
    ...
    { title:'The Jar',
      ...
      options:['Relationships are worth more than things','Buying a phone leaves you friendless','New phones are not worth the money','Saving money always backfires'],
    ...
    { title:'The Understudy',
      ...
      options:['Preparation creates opportunity','Acting is mostly luck','Understudies almost never get a chance to perform','Learning every role in a play is a waste of time'],
